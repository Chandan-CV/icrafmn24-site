<script>
  ...
  <div>
    <div class="font-InterTight text-xl font-semibold">
      <span class="number-thingy">{countdown.days}</span> days{" "}
      <span class="number-thingy">{countdown.hours}</span> hours{" "}
      <span class="number-thingy">{countdown.minutes}</span> minutes{" "}
      <span class="number-thingy">{countdown.seconds}</span> seconds
    </div>
  </div>
