<div class="flex items-center flex-col px-8">
    ...
    <div class=" bg-orange-900 text-white p-5 rounded-2xl px-10 text-2xl font-semibold cursor-pointer "> <a href="https://www.payumoney.com/customer/users/paymentOptions/#/1011F8DA7C0FCB5EC870FBB52B99DD08/ICRAFMN_2024/219353">Register Now</a></div>
</div>
